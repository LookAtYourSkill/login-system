...
def checkPasswordLimitation(password):
    ...
    if not any(string.ascii_uppercase() in password):
    ...
    if not any(string.ascii_lowercase() in password):
    ...
    if not any(string.digits() in password):
    ...
    if not any(string.punctuation() in password):
